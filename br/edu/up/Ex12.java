        ...
        switch (escolha) {
            case 1:
                if (concessionaria.getFerrariAno() <= 2000) {
                    ...
                    concessionaria.novoPreço = concessionaria.getFerrari() + desconto;
                    System.out.println(concessionaria.novoPreço);
            ...
            case 2:
                if (concessionaria.getFiat2014Ano() <= 2000) {
                    ...
                    concessionaria.novoPreço = concessionaria.getFiat2014() + desconto;
                    System.out.println(concessionaria.novoPreço);
                    System.out.println("se vc quer ver os outros carros aperte 1 se quiser fechar o programa apert 2");
                    util.PegarNumero();
                    escolha = util.VoltarNumero1();
            ...
            case 3:
                if (concessionaria.getLamborghiniAno() <= 2000) {
                    ...
                    concessionaria.novoPreço = concessionaria.getLamborghini() + desconto;
                    System.out.println(concessionaria.novoPreço);
                    System.out.println("se vc quer ver os outros carros aperte 1 se quiser fechar o programa apert 2");
                    util.PegarNumero();
                    escolha = util.VoltarNumero1();
            ...
            case 4:
                if (concessionaria.getUnoAno() <= 2000) {
                    ...
                    concessionaria.novoPreço = concessionaria.getUno() + desconto;
                    System.out.println(concessionaria.novoPreço);
                    System.out.println("se vc quer ver os outros carros aperte 1 se quiser fechar o programa apert 2");
                    util.PegarNumero();
                    escolha = util.VoltarNumero1();
