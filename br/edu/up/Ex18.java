...
public class Ex18 {
    public static void run(){
        ...
        if (usuario.getSexo().equals("f") || usuario.getSexo().equals("F") || usuario.getSexo().equals("Feminino") || usuario.getSexo().equals("feminino")) {
            ...
            if (usuario.getSexo().equals("m") || usuario.getSexo().equals("M") || usuario.getSexo().equals("Masculino") || usuario.getSexo().equals("masculino")) {
                System.out.println("me infome sua idade");
                util.PegarNumero();
                usuario.setIdade(util.VoltarNumero1());
                if (usuario.getIdade() >= 30) {
